...
export const SETTINGS_COPY = Object.freeze({
  ...
  "settings.destination.check.button": ["TODO(copy)", { slots: {}, fixedBy: "SPEC §5 (2026-09-16, #757)" }],
  "settings.destination.check.live": ["TODO(copy)", { slots: {}, fixedBy: "SPEC §5 (2026-09-16, #757)" }],
  "settings.destination.check.pending-dns": ["TODO(copy)", { slots: {}, fixedBy: "SPEC §5 (2026-09-16, #757)" }],
  "settings.destination.check.could-not-ask": ["TODO(copy)", { slots: {}, fixedBy: "SPEC §5 (2026-09-16, #757)" }],
  /** `seconds` is how long until the press may ask again, as a whole
   *  number. */
  "settings.destination.check.too-soon": ["TODO(copy)", { slots: { seconds: "text" }, fixedBy: "SPEC §5 (2026-09-16, #757)" }],

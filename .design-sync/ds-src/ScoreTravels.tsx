...
export function ScoreTravels() {
  return (
    <section style={{ maxWidth: 1180, margin: "0 auto", padding: "0 28px 70px" }}>
      <div style={{ borderRadius: 22, background: "var(--c-action)", padding: 48, color: "var(--c-on-dark)", boxShadow: "0 24px 60px -22px rgba(110,86,247,0.6)", display: "grid", gridTemplateColumns: "1fr auto", gap: 40, alignItems: "center" }}>
        <div>
        ...
        <div style={{ background: "var(--c-dark)", borderRadius: 16, padding: 26, width: 280, boxShadow: "0 20px 40px -16px rgba(0,0,0,0.5)" }}>

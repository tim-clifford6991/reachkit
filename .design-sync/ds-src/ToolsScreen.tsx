...
const TOOLS = [
  { title: "Discoverability Score", blurb: "Paste any App Store URL or website and get a 0–100 score across every signal we can measure from your live page — search, AI answers, content, competitors — plus your biggest gaps. Free, no account.", cta: "Run a free scan →", href: "/scan" },
...
export function ToolsScreen() {
  return (
    <div style={{ background: "var(--c-bg)", fontFamily: "var(--font-sans)", color: "var(--c-ink)" }}>
      <NavBar />
      <PageHeader center padding="70px 28px 24px" eyebrow="Free tools" title="Free tools to help you get found" subhead="Single-purpose checkers that run on your live site — no signup, no email. Each one covers a slice of the full ReachKit Discoverability Score." />

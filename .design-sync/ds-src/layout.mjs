...
const META = {
  ...
  CompetitorEdgePanel: { group: "App", render: "{channels:[{action:'Get listed on G2',type:'directory',host:'g2.com',competitorsUsing:2},{action:'Launch on Product Hunt',type:'community',host:'producthunt.com',competitorsUsing:1}]}" },
  CompetitorGapMap:    { group: "App", render: "{entities:[{domain:'you.com',isSubject:true},{domain:'otter.ai'},{domain:'fireflies.ai'},{domain:'fathom.video'}],channelStrength:{'you.com':{reviews:'lo',directories:'absent',community:'med',media:'absent',partners:'lo'},'otter.ai':{reviews:'hi',directories:'hi',community:'hi',media:'med',partners:'hi'},'fireflies.ai':{reviews:'hi',directories:'med',community:'med',media:'hi',partners:'med'},'fathom.video':{reviews:'med',directories:'hi',community:'lo',media:'med',partners:'lo'}},selected:'otter.ai'}" },
  ...
  RankTargets:         { group: "App", render: "{}" },
  AddToPlan:           { group: "App", render: "{}" },
  PlanItemCard:        { group: "App", render: "{doFirst:true,kind:'distribution',horizon:'long',channel:'directory',title:'Guest post on 3 podcast-tool roundups',why:'Closes the referral gap vs fathom.video',effortMin:20,priority:'high',from:'Outreach pillar · weakest lever',openLabel:'Draft the pitch',predictedPts:'+9 pts',status:'This week',statusColor:'var(--c-action)'}" },

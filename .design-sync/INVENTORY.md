...
| PlanItemCard | App | `components/app/intel/plan-entry-card.tsx` execute-in-place plan entry (WS3: kind + horizon badges — Quick win/This week/Compounding — priority, effort, thread-specific "Open in X →" for reply entries) |

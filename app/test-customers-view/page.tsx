...
const SAMPLE: Demand = {
  ...
  community: {
    pockets: [
      { surface: "r/sales", platform: "reddit", count: 14, intentSum: 9, topThreads: [{ title: "What's everyone using for automatic call notes now?", url: "https://reddit.com/r/sales/1", intent: 4, publishedAt: "2026-06-20T00:00:00Z", theme: "AI meeting notes" }] },
      { surface: "r/SaaS", platform: "reddit", count: 9, intentSum: 5, topThreads: [{ title: "Best tool to summarize customer calls for the whole team", url: "https://reddit.com/r/saas/1", intent: 3, publishedAt: "2026-06-10T00:00:00Z", theme: "Sales call summaries" }] },
      { surface: "r/CustomerSuccess", platform: "reddit", count: 6, intentSum: 3, topThreads: [{ title: "How do you keep QBR notes consistent across CSMs?", url: "https://reddit.com/r/customersuccess/1", intent: 2, publishedAt: "2026-05-28T00:00:00Z", theme: "Meeting prep tools" }] },
    ],
  },
  buyerInsights: {
    ...
    sources: ["g2.com/products/gong", "trustradius.com/products/chorus"],
  },
};

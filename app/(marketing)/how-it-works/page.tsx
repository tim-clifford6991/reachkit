    ...
    <main aria-label="How ReachKit works" style={{ background: "var(--c-surface)" }}>
      ...
      <section style={{ position: "relative", overflow: "hidden", background: "radial-gradient(1100px 480px at 50% -8%, var(--c-soft) 0%, rgba(242,238,255,0) 62%), var(--c-bg)" }}>
        <div style={{ maxWidth: 1180, margin: "0 auto", padding: "72px 28px 40px", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 17.5, lineHeight: 1.5, color: "var(--c-muted)", margin: "18px auto 0", maxWidth: 580 }}>
      ...
      <section style={{ maxWidth: 1180, margin: "0 auto", padding: "32px 28px 90px" }}>
        <div style={{ background: "linear-gradient(135deg, var(--c-dark), var(--c-dark2))", borderRadius: 22, padding: "44px 32px", textAlign: "center" }}>

...
export default function ContactPage() {
  return (
    <main aria-label="Contact ReachKit" style={{ background: "var(--c-surface)" }}>
      <section style={{ position: "relative", overflow: "hidden", background: "radial-gradient(1100px 480px at 50% -8%, var(--c-soft) 0%, rgba(242,238,255,0) 62%), #fff" }}>
        <div style={{ maxWidth: 1180, margin: "0 auto", padding: "72px 28px 0" }}>
          ...
          <h1 style={{ fontFamily: SG, fontWeight: 700, fontSize: "clamp(2rem, 4.5vw, 3.4rem)", letterSpacing: "-0.02em", lineHeight: 1.04, color: "var(--c-ink)", margin: "16px 0 0", maxWidth: 700 }}>
            Talk to us
          </h1>
      ...
      <section style={{ maxWidth: 1180, margin: "0 auto", padding: "32px 28px 28px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          {CHANNELS.map((c) => (
            <a
              ...
              style={{ display: "flex", flexDirection: "column", gap: 6, background: "var(--c-surface)", border: "1px solid var(--c-line)", borderRadius: 16, padding: "24px 26px", textDecoration: "none" }}
            >
              <span style={{ fontFamily: JM, fontSize: 11, fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--c-faint)" }}>
                {c.label}
              </span>
              <span style={{ fontFamily: SG, fontWeight: 700, fontSize: 18, letterSpacing: "-0.01em", color: "var(--c-action)" }}>
                {c.value}
              </span>
              <span style={{ fontSize: 14.5, lineHeight: 1.5, color: "var(--c-muted)" }}>
                {c.note}
              </span>
            </a>
          ))}
        ...
        <p style={{ fontSize: 14.5, lineHeight: 1.5, color: "var(--c-muted)", margin: "28px 0 0" }}>
          Looking for legal details? See the{" "}
          <Link href="/imprint" style={{ color: "var(--c-action)", fontWeight: 600, textDecoration: "none" }}>
            Imprint
          </Link>
          .
        </p>

...
export default function AboutPage() {
  return (
    <main aria-label="About ReachKit" style={{ background: "var(--c-surface)" }}>
      <section style={{ position: "relative", overflow: "hidden", background: "radial-gradient(1100px 480px at 50% -8%, var(--c-soft) 0%, rgba(242,238,255,0) 62%), #fff" }}>
        <div style={{ maxWidth: 1180, margin: "0 auto", padding: "72px 28px 0" }}>
          ...
          <h1 style={{ fontFamily: SG, fontWeight: 700, fontSize: "clamp(2rem, 4.5vw, 3.4rem)", letterSpacing: "-0.02em", lineHeight: 1.04, color: "var(--c-ink)", margin: "16px 0 0", maxWidth: 760 }}>
      ...
      <section style={{ maxWidth: 1180, margin: "0 auto", padding: "32px 28px 28px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 18, maxWidth: 720 }}>
          ...
          <p style={{ fontSize: 17.5, lineHeight: 1.5, color: "var(--c-muted)", margin: 0 }}>
            It&apos;s made by{" "}
            <span style={{ color: "var(--c-ink)", fontWeight: 600 }}>Tim Clifford</span>, a solo

...
| 2 | `SPEC.md` | The specification: stack, journey, screens, scoring, data, jobs, mail, payments, guardrails, env, build order. |
...
| 5 | `SPEC.md` §6.8 | The price book behind BUILD §6. |
...
(`SPEC.md`, `DECISIONS.md`, `ARCHITECTURE.md`, `.github/**`, `scripts/**`, the lint and test
...
Inngest, DataForSEO, Anthropic — `SPEC.md` §1. Environments and where each binding lives:
`docs/DEPLOYMENT.md`.

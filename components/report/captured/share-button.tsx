  ...
  return (
    <>
      <button
        ...
        style={{ display: "flex", alignItems: "center", gap: 7, fontFamily: PJ, fontWeight: 600, fontSize: 13.5, color: "#6E56F7", background: "#fff", border: "1.5px solid #E2DBF7", borderRadius: 9, padding: "8px 14px", cursor: "pointer" }}
      >
        ...
        >
          <div onClick={(e) => e.stopPropagation()} style={{ width: "100%", maxWidth: 380, overflow: "hidden", borderRadius: 18, background: "#fff", boxShadow: "0 40px 90px -30px oklch(0.14 0.01 285 / 0.6)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, padding: 18 }}>
              ...
              <button type="button" onClick={copy} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, borderRadius: 10, border: "1px solid #ECEAF3", padding: "11px 14px", fontFamily: PJ, fontSize: 14, fontWeight: 600, color: "#14131A", background: "#fff", cursor: "pointer" }}>

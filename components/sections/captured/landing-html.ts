export const LANDING_HTML = `<main>
    <section style="position: relative; overflow: hidden; background: radial-gradient(1100px 480px at 50% -8%, var(--c-soft) 0%, rgba(242, 238, 255, 0) 62%), rgb(255, 255, 255);">
      <div style="max-width: 1180px; margin: 0px auto; padding: 70px 28px 52px; text-align: center;">
        ...
        <h1 style="font-family: &quot;Space Grotesk&quot;; font-weight: 700; font-size: 57px; line-height: 1.04; letter-spacing: -0.035em; margin: 22px auto 0px; max-width: 860px; text-wrap: balance;">Your competitors are being found. <em style="font-style: italic; background: color-mix(in oklab, var(--c-band-invisible) 16%, transparent); color: var(--c-ink); padding: 0 0.16em; border-radius: 0.4em; box-decoration-break: clone; -webkit-box-decoration-break: clone;">You aren't.</em> <span style="color: var(--c-action);">See exactly why.</span></h1>

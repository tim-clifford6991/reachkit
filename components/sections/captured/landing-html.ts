...
export const LANDING_HTML = `<section id="story" class="rk-reveal" style="max-width: 980px; margin: 0px auto; padding: 60px 28px 20px; text-align: center;">
    ...
    <section style="max-width: 1180px; margin: 0px auto; padding: 40px 28px 56px;">
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 220px), 1fr)); gap: 22px;">
    ...
    <section class="rk-reveal" style="background: var(--c-dark); color: rgb(255, 255, 255);">
      <div style="max-width: 1180px; margin: 0px auto; padding: 70px 28px; display: grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 300px), 1fr)); gap: 54px; align-items: center;">
        <div>
    ...
    <section class="rk-reveal" style="max-width: 1080px; margin: 0px auto; padding: 70px 28px 20px;">
      ...
      <div class="rk-cmp" style="border: 1px solid var(--c-line); border-radius: 16px; overflow: hidden;">
        <div class="rk-cmp-row" style="display: grid; grid-template-columns: 1.6fr 1fr 1fr 1fr; background: var(--c-bg2); border-bottom: 1px solid var(--c-line2);">
          <div class="rk-cmp-feat" style="padding: 18px 22px;"></div>
          ...
          <div class="rk-cmp-row" style="display: grid; grid-template-columns: 1.6fr 1fr 1fr 1fr; border-bottom: 1px solid var(--c-fill); align-items: center;">
            <div class="rk-cmp-feat" style="padding: 15px 22px; font-size: 14.5px; font-weight: 600; color: var(--c-muted);"><span class="sc-interp">Reads your live page</span></div>
          ...
          <div class="rk-cmp-row" style="display: grid; grid-template-columns: 1.6fr 1fr 1fr 1fr; border-bottom: 1px solid var(--c-fill); align-items: center;">
            <div class="rk-cmp-feat" style="padding: 15px 22px; font-size: 14.5px; font-weight: 600; color: var(--c-muted);"><span class="sc-interp">One clear score</span></div>
            <div style="padding: 15px 16px; text-align: center; background: var(--c-soft); font-size: 14px; font-weight: 700; color: rgb(31, 157, 91);"><span class="sc-interp">Yes</span></div>
          ...
          <div class="rk-cmp-row" style="display: grid; grid-template-columns: 1.6fr 1fr 1fr 1fr; border-bottom: 1px solid var(--c-fill); align-items: center;">
            <div class="rk-cmp-feat" style="padding: 15px 22px; font-size: 14.5px; font-weight: 600; color: var(--c-muted);"><span class="sc-interp">Ranked, drafted fixes</span></div>
            <div style="padding: 15px 16px; text-align: center; background: var(--c-soft); font-size: 14px; font-weight: 700; color: rgb(31, 157, 91);"><span class="sc-interp">Yes</span></div>
          ...
          <div class="rk-cmp-row" style="display: grid; grid-template-columns: 1.6fr 1fr 1fr 1fr; border-bottom: 1px solid var(--c-fill); align-items: center;">
            <div class="rk-cmp-feat" style="padding: 15px 22px; font-size: 14.5px; font-weight: 600; color: var(--c-muted);"><span class="sc-interp">Verifies the fix shipped</span></div>
            <div style="padding: 15px 16px; text-align: center; background: var(--c-soft); font-size: 14px; font-weight: 700; color: rgb(31, 157, 91);"><span class="sc-interp">Yes</span></div>
            <div style="padding: 15px 16px; text-align: center; font-size: 14px; color: var(--c-faint);"><span class="sc-interp">No</span></div>
            <div style="padding: 15px 16px; text-align: center; font-size: 14px; color: var(--c-faint);"><span class="sc-interp">No</span></div>
          </div>
          <div class="rk-cmp-row" style="display: grid; grid-template-columns: 1.6fr 1fr 1fr 1fr; border-bottom: 1px solid var(--c-fill); align-items: center;">
            <div class="rk-cmp-feat" style="padding: 15px 22px; font-size: 14.5px; font-weight: 600; color: var(--c-muted);"><span class="sc-interp">Built for one founder</span></div>
            <div style="padding: 15px 16px; text-align: center; background: var(--c-soft); font-size: 14px; font-weight: 700; color: rgb(31, 157, 91);"><span class="sc-interp">Yes</span></div>
    ...
    <section class="rk-reveal" style="max-width: 1180px; margin: 0px auto; padding: 0px 28px 70px;">
      <div class="rk-travel" style="border-radius: 22px; background: var(--c-action); padding: clamp(24px, 6vw, 48px); color: rgb(255, 255, 255); box-shadow: rgba(110, 86, 247, 0.6) 0px 24px 60px -22px; display: grid; grid-template-columns: 1fr auto; gap: clamp(24px, 4vw, 40px); align-items: center;">
        <div>
        ...
        <div style="background: var(--c-dark); border-radius: 16px; padding: 26px; width: 100%; max-width: 280px; box-shadow: rgba(0, 0, 0, 0.5) 0px 20px 40px -16px;">

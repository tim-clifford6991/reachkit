  ...
  return (
    <section style={{ position: "relative", overflow: "hidden", background: "radial-gradient(1100px 480px at 50% -8%, #F2EEFF 0%, rgba(242,238,255,0) 62%), #fff" }}>
      <div style={{ maxWidth: 1180, margin: "0 auto", padding: "70px 28px 56px", textAlign: "center" }}>
        <span style={{ display: "inline-flex", alignItems: "center", gap: 8, fontFamily: JM, fontSize: 12.5, fontWeight: 600, letterSpacing: "0.04em", color: "#6E56F7", background: "#fff", border: "1px solid #E7E0FB", borderRadius: 999, padding: "7px 15px" }}>
          <span style={{ width: 6, height: 6, borderRadius: 999, background: "#6E56F7" }} />
        ...
        <h1 style={{ fontFamily: SG, fontWeight: 700, fontSize: "clamp(2.4rem, 5.4vw, 57px)", lineHeight: 1.04, letterSpacing: "-0.035em", margin: "22px auto 0", maxWidth: 860, textWrap: "balance" } as React.CSSProperties}>
          One number tells you how findable you are. <span style={{ color: "#6E56F7" }}>And the 7 fixes that move it.</span>
        </h1>

        <p style={{ fontSize: 19, lineHeight: 1.55, color: "#56535F", maxWidth: 600, margin: "20px auto 0", textWrap: "pretty" } as React.CSSProperties}>
        ...
        <p style={{ fontFamily: JM, fontSize: 12.5, color: "#9A97A5", margin: "14px auto 0" }}>
          90 seconds · No login for your first scan · Try: bloom.io
        </p>

        {/* Proof card — browser-framed sample report */}
        <div style={{ maxWidth: 760, margin: "44px auto 0", background: "#fff", border: "1px solid #ECEAF3", borderRadius: 16, overflow: "hidden", boxShadow: "0 30px 80px -28px rgba(40,33,84,0.22)", textAlign: "left" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "12px 16px", borderBottom: "1px solid #F0EEF6", background: "#FBFAFD" }}>
            <span style={{ display: "flex", gap: 6 }}>
              <span style={{ width: 11, height: 11, borderRadius: 999, background: "#FF5F57" }} />
              <span style={{ width: 11, height: 11, borderRadius: 999, background: "#FEBC2E" }} />
              <span style={{ width: 11, height: 11, borderRadius: 999, background: "#28C840" }} />
            </span>
            <span style={{ fontFamily: JM, fontSize: 12, color: "#9A97A5", background: "#F4F2FA", borderRadius: 7, padding: "5px 12px" }}>app.reachkit.io/report/bloom.io</span>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "190px 1fr", gap: 24, padding: "26px 28px", alignItems: "center" }}>
            <div style={{ textAlign: "center" }}>
              <svg width="180" height="180" viewBox="0 0 180 180" style={{ display: "block", margin: "0 auto" }}>
                ...
                <text x="90" y="92" textAnchor="middle" style={{ font: `700 38px ${JM}, monospace`, fill: "#14131A" }}>47</text>
                <text x="90" y="110" textAnchor="middle" style={{ font: `600 10px ${JM}, monospace`, fill: "#9A97A5" }}>/ 100</text>
              </svg>
              <div style={{ fontFamily: JM, fontSize: 11, color: "#9A97A5", marginTop: 4 }}>Discoverability Score</div>
            ...
            <div>
              <div style={{ fontFamily: JM, fontSize: 11, fontWeight: 700, letterSpacing: "0.08em", color: "#9A97A5" }}>3 PILLARS</div>
              {[{ l: "Content", v: 56, c: "#E0731C" }, { l: "Outreach", v: 29, c: "#E5484D" }, { l: "SEO", v: 54, c: "#E0731C" }].map((p) => (
                <div key={p.l} style={{ display: "flex", alignItems: "center", gap: 12, marginTop: 12 }}>
                  <span style={{ width: 64, fontSize: 13, fontWeight: 600, color: "#14131A" }}>{p.l}</span>
                  <span style={{ flex: 1, height: 7, borderRadius: 4, background: "#F2F0F8", overflow: "hidden" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 18, paddingTop: 14, borderTop: "1px solid #F0EEF6" }}>
                <span style={{ width: 22, height: 22, borderRadius: 6, background: "#F2EEFF", color: "#6E56F7", fontFamily: JM, fontWeight: 700, fontSize: 11, display: "flex", alignItems: "center", justifyContent: "center" }}>1</span>
                <span style={{ flex: 1, fontSize: 13.5, fontWeight: 600, color: "#14131A" }}>Publish 3 &ldquo;vs competitor&rdquo; comparison pages</span>

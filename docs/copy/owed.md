...
**154 keys**, across 796 in the registry — **5 empty** (`copy()` throws on these: a mail with one does not send, a screen with one does not render) and **149 `TODO(copy)`** (these render the marker, in public, until they are written).
...
| S2 | [Free report](#s2-free-report-public) | 46 | 4 |
...
| S18 | [Settings](#s18-settings-app) | 10 | 1 |

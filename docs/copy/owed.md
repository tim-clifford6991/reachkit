...
|---|---|---|---|---|---|
| `setup.competitors.found`<br>`setup.ts` | marker | control · `<p>` · `app/(account)/setup/SetupForm.tsx` |  | SPEC §5 · Canvas: OnboardingCompetitors | 123 — sibling `setup.competitors.none-found` |

...
| 8 | `docs/RUNBOOK.md` | Operating the product alone: jobs, kill switch, cost ledger, backups, incidents. **Not yet written — #333.** | an operational procedure is added or rehearsed | — (rehearsals are dated inside it) |

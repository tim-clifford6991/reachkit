...
| file | what it is |
|---|---|
| `docs/archive/2026-09-08-parent-artifact/reachkit-screen-system.html` | the artifact itself — one page, eight screens rendered from its own JavaScript |
| `tokens.css` | its three token blocks, verbatim: the source of truth for `src/ui/theme.css` |
| `docs/archive/2026-09-08-parent-artifact/literals.md` | every length and colour it spends *outside* those blocks, with selector and count — the list the owner rules on |
| `screens/*.png` | each screen at 1280, light and dark |

## Viewing it

Open `docs/archive/2026-09-08-parent-artifact/reachkit-screen-system.html` in a browser. It needs no server and no
...
- `docs/archive/2026-09-08-parent-artifact/literals.md` is not a defect list. A literal in an approved design is

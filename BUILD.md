...
Two-column cards (S18). Left: **Your site & market** (domain + Change · category + Edit · rebuild line) · **Competitors** (5 removable tags) · **Publishing** (Autopilot/Copilot pair + one line on what the pair does · veto window stepper 0–7 days, default 1 day — **2026-09-10 (brief §1.8, §1.1):** becomes 1–7 days and the pair is no longer a customer choice, see §9; 0 is removed by the setup/settings issue (#TBD), and the pin and this sentence move together when it lands · publish time · time zone · publishing on/off · destinations with health + Reconnect · "Fix-type tasks are never automated, whatever the mode.") · **How your pages sound** (voice field · *Never claim* list + add) · **Notifications** (Daily draft-ready mail · Published-page mail · Monday movement mail). Right: **Billing** · **Account** · **Your content** · **Danger zone** as before.

...
function makePayload(total: number): ReportPayload {
  ...
  return {
    ...
    score: {
      ...
      basis: "verified",
      radar: [
        { axis: "Content",      value: breakdown.content,  active: true,  assessed: true  },
        { axis: "Outreach",     value: breakdown.outreach, active: true,  assessed: true  },
        { axis: "SEO/ASO",      value: breakdown.seo,      active: true,  assessed: true  },

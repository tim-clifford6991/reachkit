...
function baseResult(): FunnelResult {
  ...
  return {
    ...
    category: "notetaking",
    competitors: [{ domain: "rival.com", isSubject: false, monthlyTraffic: 100, score: 50, band: "b", mix: null, paidEtv: 0, brandedSearchVolume: 0, topPagesCount: 0, lens: null, closeness: 1, reason: "", backlinks: bd({ marketplace: 12 }, ["g2.com", "capterra.com"]) }],
